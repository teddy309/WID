...
var NumVertices  = 36;//6sides*square(2 triangles 3*2=6)
...
{
    var vertices = [
        vec4( -0.5, -0.5,  0.5, 1.0 ), // top 4 nodes
        vec4( -0.5,  0.5,  0.5, 1.0 ),
        vec4(  0.5,  0.5,  0.5, 1.0 ),
        vec4(  0.5, -0.5,  0.5, 1.0 ),
        vec4( -0.5, -0.5, -0.5, 1.0 ), //bottom 4 nodes
        vec4( -0.5,  0.5, -0.5, 1.0 ),
        vec4(  0.5,  0.5, -0.5, 1.0 ),
        vec4(  0.5, -0.5, -0.5, 1.0 )
    ];
    ...
    for ( var i = 0; i < indices.length; ++i ) {
        points.push( vertices[indices[i]] * 0.9 );
